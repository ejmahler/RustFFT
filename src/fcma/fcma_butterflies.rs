...
#[allow(unused)]
macro_rules! boilerplate_fft_fcma_f32_butterfly {
        ...
        impl<T: FftNum> Fft<T> for $struct_name<T> {
            fn process_immutable_with_scratch(
                ...
                unsafe {
                    ...
                    super::fcma_common::fcma_fft_helper_immut_unroll2x(
                        simd_input,
                        simd_output,
                        self.len(),
                        |input, output| {
            ...
            fn process_outofplace_with_scratch(
                ...
                unsafe {
                    ...
                    let simd_output = crate::array_utils::workaround_transmute_mut(output);
                    super::fcma_common::fcma_fft_helper_outofplace_unroll2x(
                        simd_input,
                        simd_output,
                        self.len(),
                        |input, output| {
            ...
            fn process_with_scratch(&self, buffer: &mut [Complex<T>], _scratch: &mut [Complex<T>]) {
                unsafe {
                    ...
                    super::fcma_common::fcma_fft_helper_inplace_unroll2x(
                        simd_buffer,
                        self.len(),
...
macro_rules! boilerplate_fft_fcma_f64_butterfly {
    ($struct_name:ident, $len:expr, $direction_fn:expr) => {
        impl<T: FftNum> Fft<T> for $struct_name<T> {
            fn process_immutable_with_scratch(
                &self,
...
pub struct FcmaF32Butterfly1<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
}

boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly1, 1, |this: &FcmaF32Butterfly1<_>| this
    .direction);
impl<T: FftNum> FcmaF32Butterfly1<T> {
    #[inline(always)]
...
pub struct FcmaF64Butterfly1<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
}

boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly1, 1, |this: &FcmaF64Butterfly1<_>| this
    .direction);
impl<T: FftNum> FcmaF64Butterfly1<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        Self {
...
pub struct FcmaF32Butterfly2<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
}

boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly2, 2, |this: &FcmaF32Butterfly2<_>| this
    .direction);
impl<T: FftNum> FcmaF32Butterfly2<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        Self {
...
pub struct FcmaF64Butterfly2<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
}

boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly2, 2, |this: &FcmaF64Butterfly2<_>| this
    .direction);
impl<T: FftNum> FcmaF64Butterfly2<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        Self {
...
pub struct FcmaF32Butterfly3<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
    rotate: Rotate90F32,
    twiddle: float32x4_t,
...
boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly3, 3, |this: &FcmaF32Butterfly3<_>| this
    .direction);
impl<T: FftNum> FcmaF32Butterfly3<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
...
boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly3, 3, |this: &FcmaF64Butterfly3<_>| this
    .direction);
impl<T: FftNum> FcmaF64Butterfly3<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
...
pub struct FcmaF32Butterfly4<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
    rotate: Rotate90F32,
}

boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly4, 4, |this: &FcmaF32Butterfly4<_>| this
    .direction);
impl<T: FftNum> FcmaF32Butterfly4<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
...
pub struct FcmaF64Butterfly4<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
    rotate: Rotate90F64,
}

boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly4, 4, |this: &FcmaF64Butterfly4<_>| this
    .direction);
impl<T: FftNum> FcmaF64Butterfly4<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        let rotate = if direction == FftDirection::Inverse {
...
pub struct FcmaF32Butterfly5<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
    rotate: Rotate90F32,
...
boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly5, 5, |this: &FcmaF32Butterfly5<_>| this
    .direction);
impl<T: FftNum> FcmaF32Butterfly5<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        let rotate = Rotate90F32::new(true);
...
pub struct FcmaF64Butterfly5<T> {
    direction: FftDirection,
    _phantom: std::marker::PhantomData<T>,
    rotate: Rotate90F64,
    twiddle1re: float64x2_t,
...
boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly5, 5, |this: &FcmaF64Butterfly5<_>| this
    .direction);
impl<T: FftNum> FcmaF64Butterfly5<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        let rotate = Rotate90F64::new(true);
...
pub struct FcmaF32Butterfly6<T> {
    _phantom: std::marker::PhantomData<T>,
    bf3: FcmaF32Butterfly3<T>,
}

boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly6, 6, |this: &FcmaF32Butterfly6<_>| this
    .bf3
    .direction);
impl<T: FftNum> FcmaF32Butterfly6<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        let bf3 = FcmaF32Butterfly3::new(direction);
...
pub struct FcmaF64Butterfly6<T> {
    _phantom: std::marker::PhantomData<T>,
    bf3: FcmaF64Butterfly3<T>,
}

boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly6, 6, |this: &FcmaF64Butterfly6<_>| this
    .bf3
    .direction);
impl<T: FftNum> FcmaF64Butterfly6<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        let bf3 = FcmaF64Butterfly3::new(direction);
...
boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly8, 8, |this: &FcmaF32Butterfly8<_>| this
    .bf4
    .direction);
impl<T: FftNum> FcmaF32Butterfly8<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
...
boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly8, 8, |this: &FcmaF64Butterfly8<_>| this
    .bf4
    .direction);
impl<T: FftNum> FcmaF64Butterfly8<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
...
boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly9, 9, |this: &FcmaF32Butterfly9<_>| this
    .bf3
    .direction);
impl<T: FftNum> FcmaF32Butterfly9<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        let bf3 = FcmaF32Butterfly3::new(direction);
...
boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly9, 9, |this: &FcmaF64Butterfly9<_>| this
    .bf3
    .direction);
impl<T: FftNum> FcmaF64Butterfly9<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        let bf3 = FcmaF64Butterfly3::new(direction);
...
pub struct FcmaF32Butterfly10<T> {
    _phantom: std::marker::PhantomData<T>,
    bf5: FcmaF32Butterfly5<T>,
}

boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly10, 10, |this: &FcmaF32Butterfly10<_>| this
    .bf5
    .direction);
impl<T: FftNum> FcmaF32Butterfly10<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        let bf5 = FcmaF32Butterfly5::new(direction);
        Self {
            _phantom: std::marker::PhantomData,
            bf5,
        }
...
pub struct FcmaF64Butterfly10<T> {
    _phantom: std::marker::PhantomData<T>,
    bf2: FcmaF64Butterfly2<T>,
    bf5: FcmaF64Butterfly5<T>,
}

boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly10, 10, |this: &FcmaF64Butterfly10<_>| this
    .bf5
    .direction);
impl<T: FftNum> FcmaF64Butterfly10<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        let bf2 = FcmaF64Butterfly2::new(direction);
        let bf5 = FcmaF64Butterfly5::new(direction);
        Self {
            _phantom: std::marker::PhantomData,
            bf2,
            bf5,
...
pub struct FcmaF32Butterfly12<T> {
    _phantom: std::marker::PhantomData<T>,
    bf3: FcmaF32Butterfly3<T>,
    bf4: FcmaF32Butterfly4<T>,
}

boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly12, 12, |this: &FcmaF32Butterfly12<_>| this
    .bf4
    .direction);
impl<T: FftNum> FcmaF32Butterfly12<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        let bf3 = FcmaF32Butterfly3::new(direction);
...
pub struct FcmaF64Butterfly12<T> {
    _phantom: std::marker::PhantomData<T>,
    bf3: FcmaF64Butterfly3<T>,
    bf4: FcmaF64Butterfly4<T>,
}

boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly12, 12, |this: &FcmaF64Butterfly12<_>| this
    .bf4
    .direction);
impl<T: FftNum> FcmaF64Butterfly12<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        let bf3 = FcmaF64Butterfly3::new(direction);
...
//
pub struct FcmaF32Butterfly15<T> {
    _phantom: std::marker::PhantomData<T>,
    bf3: FcmaF32Butterfly3<T>,
    bf5: FcmaF32Butterfly5<T>,
}

boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly15, 15, |this: &FcmaF32Butterfly15<_>| this
    .bf3
    .direction);
impl<T: FftNum> FcmaF32Butterfly15<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        let bf3 = FcmaF32Butterfly3::new(direction);
...
pub struct FcmaF64Butterfly15<T> {
    _phantom: std::marker::PhantomData<T>,
    bf3: FcmaF64Butterfly3<T>,
    bf5: FcmaF64Butterfly5<T>,
}

boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly15, 15, |this: &FcmaF64Butterfly15<_>| this
    .bf3
    .direction);
impl<T: FftNum> FcmaF64Butterfly15<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        let bf3 = FcmaF64Butterfly3::new(direction);
...
boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly16, 16, |this: &FcmaF32Butterfly16<_>| this
    .bf4
    .direction);
impl<T: FftNum> FcmaF32Butterfly16<T> {
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        ...
        unsafe {
            Self {
                bf4: FcmaF32Butterfly4::new(direction),
                twiddles_packed: [
                    pack_32(tw0, tw1),
                    pack_32(tw0, tw2),
                    pack_32(tw0, tw3),
...
boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly16, 16, |this: &FcmaF64Butterfly16<_>| this
    .bf4
    .direction);
impl<T: FftNum> FcmaF64Butterfly16<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        ...
        unsafe {
            Self {
                bf4: FcmaF64Butterfly4::new(direction),
...
boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly24, 24, |this: &FcmaF32Butterfly24<_>| this
    .bf4
    .direction);
impl<T: FftNum> FcmaF32Butterfly24<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        let tw0: Complex<f32> = Complex { re: 1.0, im: 0.0 };
        ...
        unsafe {
            Self {
                bf4: FcmaF32Butterfly4::new(direction),
                bf6: FcmaF32Butterfly6::new(direction),
                twiddles_packed: [
                    pack_32(tw0, tw1),
                    pack_32(tw0, tw2),
                    pack_32(tw0, tw3),
...
boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly24, 24, |this: &FcmaF64Butterfly24<_>| this
    .bf4
    .direction);
impl<T: FftNum> FcmaF64Butterfly24<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        ...
        unsafe {
            Self {
                bf4: FcmaF64Butterfly4::new(direction),
                bf6: FcmaF64Butterfly6::new(direction),
                twiddle1: pack_64(tw1),
...
boilerplate_fft_fcma_f32_butterfly!(FcmaF32Butterfly32, 32, |this: &FcmaF32Butterfly32<_>| this
    ...
    .bf4
    .direction);
impl<T: FftNum> FcmaF32Butterfly32<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f32::<T>();
        let tw0: Complex<f32> = Complex { re: 1.0, im: 0.0 };
        ...
        unsafe {
            Self {
                bf8: FcmaF32Butterfly8::new(direction),
                twiddles_packed: [
                    pack_32(tw0, tw1),
                    pack_32(tw0, tw2),
                    pack_32(tw0, tw3),
...
boilerplate_fft_fcma_f64_butterfly!(FcmaF64Butterfly32, 32, |this: &FcmaF64Butterfly32<_>| this
    ...
    .bf4
    .direction);
impl<T: FftNum> FcmaF64Butterfly32<T> {
    #[inline(always)]
    pub fn new(direction: FftDirection) -> Self {
        assert_f64::<T>();
        ...
        unsafe {
            Self {
                bf8: FcmaF64Butterfly8::new(direction),
                twiddle1: pack_64(tw1),
                twiddle2: pack_64(tw2),
                twiddle3: pack_64(tw3),
                twiddle5: pack_64(tw5),
...
mod unit_tests {
    ...
    test_butterfly_32_func!(test_fcmaf32_butterfly1, FcmaF32Butterfly1, 1);
    test_butterfly_32_func!(test_fcmaf32_butterfly2, FcmaF32Butterfly2, 2);
    test_butterfly_32_func!(test_fcmaf32_butterfly3, FcmaF32Butterfly3, 3);
    test_butterfly_32_func!(test_fcmaf32_butterfly4, FcmaF32Butterfly4, 4);
    test_butterfly_32_func!(test_fcmaf32_butterfly5, FcmaF32Butterfly5, 5);
    test_butterfly_32_func!(test_fcmaf32_butterfly6, FcmaF32Butterfly6, 6);
    test_butterfly_32_func!(test_fcmaf32_butterfly8, FcmaF32Butterfly8, 8);
    test_butterfly_32_func!(test_fcmaf32_butterfly9, FcmaF32Butterfly9, 9);
    test_butterfly_32_func!(test_fcmaf32_butterfly10, FcmaF32Butterfly10, 10);
    test_butterfly_32_func!(test_fcmaf32_butterfly12, FcmaF32Butterfly12, 12);
    test_butterfly_32_func!(test_fcmaf32_butterfly15, FcmaF32Butterfly15, 15);
    test_butterfly_32_func!(test_fcmaf32_butterfly16, FcmaF32Butterfly16, 16);
    test_butterfly_32_func!(test_fcmaf32_butterfly24, FcmaF32Butterfly24, 24);
    test_butterfly_32_func!(test_fcmaf32_butterfly32, FcmaF32Butterfly32, 32);
    ...
    test_butterfly_64_func!(test_fcmaf64_butterfly1, FcmaF64Butterfly1, 1);
    test_butterfly_64_func!(test_fcmaf64_butterfly2, FcmaF64Butterfly2, 2);
    test_butterfly_64_func!(test_fcmaf64_butterfly3, FcmaF64Butterfly3, 3);
    test_butterfly_64_func!(test_fcmaf64_butterfly4, FcmaF64Butterfly4, 4);
    test_butterfly_64_func!(test_fcmaf64_butterfly5, FcmaF64Butterfly5, 5);
    test_butterfly_64_func!(test_fcmaf64_butterfly6, FcmaF64Butterfly6, 6);
    test_butterfly_64_func!(test_fcmaf64_butterfly8, FcmaF64Butterfly8, 8);
    test_butterfly_64_func!(test_fcmaf64_butterfly9, FcmaF64Butterfly9, 9);
    test_butterfly_64_func!(test_fcmaf64_butterfly10, FcmaF64Butterfly10, 10);
    test_butterfly_64_func!(test_fcmaf64_butterfly12, FcmaF64Butterfly12, 12);
    test_butterfly_64_func!(test_fcmaf64_butterfly15, FcmaF64Butterfly15, 15);
    test_butterfly_64_func!(test_fcmaf64_butterfly16, FcmaF64Butterfly16, 16);
    test_butterfly_64_func!(test_fcmaf64_butterfly24, FcmaF64Butterfly24, 24);
    test_butterfly_64_func!(test_fcmaf64_butterfly32, FcmaF64Butterfly32, 32);
    ...
    fn test_solo_fft2_32() {
        unsafe {
            ...
            let bf2 = FcmaF32Butterfly2::<f32>::new(FftDirection::Forward);
    ...
    fn test_parallel_fft2_32() {
        unsafe {
            ...
            assert!(compare_vectors(&val_b, &fcma_res_b));
        }
    }
}
