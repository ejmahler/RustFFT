...
impl<T: FftNum> FcmaF32Butterfly17<T> {
    ...
    pub(crate) unsafe fn perform_parallel_fft_direct(&self, values: [float32x4_t; 17]) -> [float32x4_t; 17] {
        ...
        let m0116b = FcmaVector::fmadd_rotate90(m0116b, self.twiddles_im[3], x4m13);
        let m0116b = FcmaVector::fmadd_rotate90(m0116b, self.twiddles_im[4], x5m12);
        ...
        let m0215b = FcmaVector::fmadd_rotate90(m0215b, self.twiddles_im[7], x4m13);
        let m0215b = FcmaVector::nmadd_rotate90(m0215b, self.twiddles_im[6], x5m12);
        ...
        let m0314b = FcmaVector::nmadd_rotate90(m0314b, self.twiddles_im[4], x4m13);
        let m0314b = FcmaVector::nmadd_rotate90(m0314b, self.twiddles_im[1], x5m12);
        ...
        let m0413b = FcmaVector::nmadd_rotate90(m0413b, self.twiddles_im[0], x4m13);
        let m0413b = FcmaVector::fmadd_rotate90(m0413b, self.twiddles_im[2], x5m12);
        ...
        let m0512b = FcmaVector::fmadd_rotate90(m0512b, self.twiddles_im[2], x4m13);
        let m0512b = FcmaVector::fmadd_rotate90(m0512b, self.twiddles_im[7], x5m12);
        ...
        let m0611b = FcmaVector::fmadd_rotate90(m0611b, self.twiddles_im[6], x4m13);
        let m0611b = FcmaVector::nmadd_rotate90(m0611b, self.twiddles_im[3], x5m12);
        ...
        let m0710b = FcmaVector::nmadd_rotate90(m0710b, self.twiddles_im[5], x4m13);
        let m0710b = FcmaVector::fmadd_rotate90(m0710b, self.twiddles_im[0], x5m12);
        ...
        let m0809b = FcmaVector::nmadd_rotate90(m0809b, self.twiddles_im[1], x4m13);
        let m0809b = FcmaVector::fmadd_rotate90(m0809b, self.twiddles_im[5], x5m12);
...
impl<T: FftNum> FcmaF32Butterfly19<T> {
    ...
    pub(crate) unsafe fn perform_parallel_fft_direct(&self, values: [float32x4_t; 19]) -> [float32x4_t; 19] {
        ...
        let m0118b = FcmaVector::fmadd_rotate90(m0118b, self.twiddles_im[3], x4m15);
        let m0118b = FcmaVector::fmadd_rotate90(m0118b, self.twiddles_im[4], x5m14);
        let m0118b = FcmaVector::fmadd_rotate90(m0118b, self.twiddles_im[5], x6m13);
        ...
        let m0217b = FcmaVector::fmadd_rotate90(m0217b, self.twiddles_im[7], x4m15);
        let m0217b = FcmaVector::nmadd_rotate90(m0217b, self.twiddles_im[8], x5m14);
        let m0217b = FcmaVector::nmadd_rotate90(m0217b, self.twiddles_im[6], x6m13);
        ...
        let m0316b = FcmaVector::nmadd_rotate90(m0316b, self.twiddles_im[6], x4m15);
        let m0316b = FcmaVector::nmadd_rotate90(m0316b, self.twiddles_im[3], x5m14);
        let m0316b = FcmaVector::nmadd_rotate90(m0316b, self.twiddles_im[0], x6m13);
        ...
        let m0415b = FcmaVector::nmadd_rotate90(m0415b, self.twiddles_im[2], x4m15);
        let m0415b = FcmaVector::fmadd_rotate90(m0415b, self.twiddles_im[0], x5m14);
        let m0415b = FcmaVector::fmadd_rotate90(m0415b, self.twiddles_im[4], x6m13);
        ...
        let m0514b = FcmaVector::fmadd_rotate90(m0514b, self.twiddles_im[0], x4m15);
        let m0514b = FcmaVector::fmadd_rotate90(m0514b, self.twiddles_im[5], x5m14);
        let m0514b = FcmaVector::nmadd_rotate90(m0514b, self.twiddles_im[7], x6m13);
        ...
        let m0613b = FcmaVector::fmadd_rotate90(m0613b, self.twiddles_im[4], x4m15);
        let m0613b = FcmaVector::nmadd_rotate90(m0613b, self.twiddles_im[7], x5m14);
        let m0613b = FcmaVector::nmadd_rotate90(m0613b, self.twiddles_im[1], x6m13);
        ...
        let m0712b = FcmaVector::fmadd_rotate90(m0712b, self.twiddles_im[8], x4m15);
        let m0712b = FcmaVector::nmadd_rotate90(m0712b, self.twiddles_im[2], x5m14);
        let m0712b = FcmaVector::fmadd_rotate90(m0712b, self.twiddles_im[3], x6m13);
        ...
        let m0811b = FcmaVector::nmadd_rotate90(m0811b, self.twiddles_im[5], x4m15);
        let m0811b = FcmaVector::fmadd_rotate90(m0811b, self.twiddles_im[1], x5m14);
        let m0811b = FcmaVector::nmadd_rotate90(m0811b, self.twiddles_im[8], x6m13);
        ...
        let m0910b = FcmaVector::nmadd_rotate90(m0910b, self.twiddles_im[1], x4m15);
        let m0910b = FcmaVector::fmadd_rotate90(m0910b, self.twiddles_im[6], x5m14);
        let m0910b = FcmaVector::nmadd_rotate90(m0910b, self.twiddles_im[2], x6m13);
...
impl<T: FftNum> FcmaF32Butterfly23<T> {
    ...
    pub(crate) unsafe fn perform_parallel_fft_direct(&self, values: [float32x4_t; 23]) -> [float32x4_t; 23] {
        ...
        let m0122b = FcmaVector::fmadd_rotate90(m0122b, self.twiddles_im[3], x4m19);
        let m0122b = FcmaVector::fmadd_rotate90(m0122b, self.twiddles_im[4], x5m18);
        let m0122b = FcmaVector::fmadd_rotate90(m0122b, self.twiddles_im[5], x6m17);
        let m0122b = FcmaVector::fmadd_rotate90(m0122b, self.twiddles_im[6], x7m16);
        let m0122b = FcmaVector::fmadd_rotate90(m0122b, self.twiddles_im[7], x8m15);
        ...
        let m0221b = FcmaVector::fmadd_rotate90(m0221b, self.twiddles_im[7], x4m19);
        let m0221b = FcmaVector::fmadd_rotate90(m0221b, self.twiddles_im[9], x5m18);
        let m0221b = FcmaVector::nmadd_rotate90(m0221b, self.twiddles_im[10], x6m17);
        let m0221b = FcmaVector::nmadd_rotate90(m0221b, self.twiddles_im[8], x7m16);
        let m0221b = FcmaVector::nmadd_rotate90(m0221b, self.twiddles_im[6], x8m15);
        ...
        let m0320b = FcmaVector::nmadd_rotate90(m0320b, self.twiddles_im[10], x4m19);
        let m0320b = FcmaVector::nmadd_rotate90(m0320b, self.twiddles_im[7], x5m18);
        let m0320b = FcmaVector::nmadd_rotate90(m0320b, self.twiddles_im[4], x6m17);
        let m0320b = FcmaVector::nmadd_rotate90(m0320b, self.twiddles_im[1], x7m16);
        let m0320b = FcmaVector::fmadd_rotate90(m0320b, self.twiddles_im[0], x8m15);
        ...
        let m0419b = FcmaVector::nmadd_rotate90(m0419b, self.twiddles_im[6], x4m19);
        let m0419b = FcmaVector::nmadd_rotate90(m0419b, self.twiddles_im[2], x5m18);
        let m0419b = FcmaVector::fmadd_rotate90(m0419b, self.twiddles_im[0], x6m17);
        let m0419b = FcmaVector::fmadd_rotate90(m0419b, self.twiddles_im[4], x7m16);
        let m0419b = FcmaVector::fmadd_rotate90(m0419b, self.twiddles_im[8], x8m15);
        ...
        let m0518b = FcmaVector::nmadd_rotate90(m0518b, self.twiddles_im[2], x4m19);
        let m0518b = FcmaVector::fmadd_rotate90(m0518b, self.twiddles_im[1], x5m18);
        let m0518b = FcmaVector::fmadd_rotate90(m0518b, self.twiddles_im[6], x6m17);
        let m0518b = FcmaVector::nmadd_rotate90(m0518b, self.twiddles_im[10], x7m16);
        let m0518b = FcmaVector::nmadd_rotate90(m0518b, self.twiddles_im[5], x8m15);
        ...
        let m0617b = FcmaVector::fmadd_rotate90(m0617b, self.twiddles_im[0], x4m19);
        let m0617b = FcmaVector::fmadd_rotate90(m0617b, self.twiddles_im[6], x5m18);
        let m0617b = FcmaVector::nmadd_rotate90(m0617b, self.twiddles_im[9], x6m17);
        let m0617b = FcmaVector::nmadd_rotate90(m0617b, self.twiddles_im[3], x7m16);
        let m0617b = FcmaVector::fmadd_rotate90(m0617b, self.twiddles_im[1], x8m15);
        ...
        let m0716b = FcmaVector::fmadd_rotate90(m0716b, self.twiddles_im[4], x4m19);
        let m0716b = FcmaVector::nmadd_rotate90(m0716b, self.twiddles_im[10], x5m18);
        let m0716b = FcmaVector::nmadd_rotate90(m0716b, self.twiddles_im[3], x6m17);
        let m0716b = FcmaVector::fmadd_rotate90(m0716b, self.twiddles_im[2], x7m16);
        let m0716b = FcmaVector::fmadd_rotate90(m0716b, self.twiddles_im[9], x8m15);
        ...
        let m0815b = FcmaVector::fmadd_rotate90(m0815b, self.twiddles_im[8], x4m19);
        let m0815b = FcmaVector::nmadd_rotate90(m0815b, self.twiddles_im[5], x5m18);
        let m0815b = FcmaVector::fmadd_rotate90(m0815b, self.twiddles_im[1], x6m17);
        let m0815b = FcmaVector::fmadd_rotate90(m0815b, self.twiddles_im[9], x7m16);
        let m0815b = FcmaVector::nmadd_rotate90(m0815b, self.twiddles_im[4], x8m15);
        ...
        let m0914b = FcmaVector::nmadd_rotate90(m0914b, self.twiddles_im[9], x4m19);
        let m0914b = FcmaVector::nmadd_rotate90(m0914b, self.twiddles_im[0], x5m18);
        let m0914b = FcmaVector::fmadd_rotate90(m0914b, self.twiddles_im[7], x6m17);
        let m0914b = FcmaVector::nmadd_rotate90(m0914b, self.twiddles_im[5], x7m16);
        let m0914b = FcmaVector::fmadd_rotate90(m0914b, self.twiddles_im[2], x8m15);
        ...
        let m1013b = FcmaVector::nmadd_rotate90(m1013b, self.twiddles_im[5], x4m19);
        let m1013b = FcmaVector::fmadd_rotate90(m1013b, self.twiddles_im[3], x5m18);
        let m1013b = FcmaVector::nmadd_rotate90(m1013b, self.twiddles_im[8], x6m17);
        let m1013b = FcmaVector::fmadd_rotate90(m1013b, self.twiddles_im[0], x7m16);
        let m1013b = FcmaVector::fmadd_rotate90(m1013b, self.twiddles_im[10], x8m15);
        ...
        let m1112b = FcmaVector::nmadd_rotate90(m1112b, self.twiddles_im[1], x4m19);
        let m1112b = FcmaVector::fmadd_rotate90(m1112b, self.twiddles_im[8], x5m18);
        let m1112b = FcmaVector::nmadd_rotate90(m1112b, self.twiddles_im[2], x6m17);
        let m1112b = FcmaVector::fmadd_rotate90(m1112b, self.twiddles_im[7], x7m16);
        let m1112b = FcmaVector::nmadd_rotate90(m1112b, self.twiddles_im[3], x8m15);
...
impl<T: FftNum> FcmaF32Butterfly29<T> {
    ...
    pub(crate) unsafe fn perform_parallel_fft_direct(&self, values: [float32x4_t; 29]) -> [float32x4_t; 29] {
        ...
        let m0128b = FcmaVector::fmadd_rotate90(m0128b, self.twiddles_im[3], x4m25);
        let m0128b = FcmaVector::fmadd_rotate90(m0128b, self.twiddles_im[4], x5m24);
        let m0128b = FcmaVector::fmadd_rotate90(m0128b, self.twiddles_im[5], x6m23);
        let m0128b = FcmaVector::fmadd_rotate90(m0128b, self.twiddles_im[6], x7m22);
        let m0128b = FcmaVector::fmadd_rotate90(m0128b, self.twiddles_im[7], x8m21);
        let m0128b = FcmaVector::fmadd_rotate90(m0128b, self.twiddles_im[8], x9m20);
        let m0128b = FcmaVector::fmadd_rotate90(m0128b, self.twiddles_im[9], x10m19);
        let m0128b = FcmaVector::fmadd_rotate90(m0128b, self.twiddles_im[10], x11m18);
        ...
        let m0227b = FcmaVector::fmadd_rotate90(m0227b, self.twiddles_im[7], x4m25);
        let m0227b = FcmaVector::fmadd_rotate90(m0227b, self.twiddles_im[9], x5m24);
        let m0227b = FcmaVector::fmadd_rotate90(m0227b, self.twiddles_im[11], x6m23);
        let m0227b = FcmaVector::fmadd_rotate90(m0227b, self.twiddles_im[13], x7m22);
        let m0227b = FcmaVector::nmadd_rotate90(m0227b, self.twiddles_im[12], x8m21);
        let m0227b = FcmaVector::nmadd_rotate90(m0227b, self.twiddles_im[10], x9m20);
        let m0227b = FcmaVector::nmadd_rotate90(m0227b, self.twiddles_im[8], x10m19);
        let m0227b = FcmaVector::nmadd_rotate90(m0227b, self.twiddles_im[6], x11m18);
        ...
        let m0326b = FcmaVector::fmadd_rotate90(m0326b, self.twiddles_im[11], x4m25);
        let m0326b = FcmaVector::nmadd_rotate90(m0326b, self.twiddles_im[13], x5m24);
        let m0326b = FcmaVector::nmadd_rotate90(m0326b, self.twiddles_im[10], x6m23);
        let m0326b = FcmaVector::nmadd_rotate90(m0326b, self.twiddles_im[7], x7m22);
        let m0326b = FcmaVector::nmadd_rotate90(m0326b, self.twiddles_im[4], x8m21);
        let m0326b = FcmaVector::nmadd_rotate90(m0326b, self.twiddles_im[1], x9m20);
        let m0326b = FcmaVector::fmadd_rotate90(m0326b, self.twiddles_im[0], x10m19);
        let m0326b = FcmaVector::fmadd_rotate90(m0326b, self.twiddles_im[3], x11m18);
        ...
        let m0425b = FcmaVector::nmadd_rotate90(m0425b, self.twiddles_im[12], x4m25);
        let m0425b = FcmaVector::nmadd_rotate90(m0425b, self.twiddles_im[8], x5m24);
        let m0425b = FcmaVector::nmadd_rotate90(m0425b, self.twiddles_im[4], x6m23);
        let m0425b = FcmaVector::nmadd_rotate90(m0425b, self.twiddles_im[0], x7m22);
        let m0425b = FcmaVector::fmadd_rotate90(m0425b, self.twiddles_im[2], x8m21);
        let m0425b = FcmaVector::fmadd_rotate90(m0425b, self.twiddles_im[6], x9m20);
        let m0425b = FcmaVector::fmadd_rotate90(m0425b, self.twiddles_im[10], x10m19);
        let m0425b = FcmaVector::nmadd_rotate90(m0425b, self.twiddles_im[13], x11m18);
        ...
        let m0524b = FcmaVector::nmadd_rotate90(m0524b, self.twiddles_im[8], x4m25);
        let m0524b = FcmaVector::nmadd_rotate90(m0524b, self.twiddles_im[3], x5m24);
        let m0524b = FcmaVector::fmadd_rotate90(m0524b, self.twiddles_im[0], x6m23);
        let m0524b = FcmaVector::fmadd_rotate90(m0524b, self.twiddles_im[5], x7m22);
        let m0524b = FcmaVector::fmadd_rotate90(m0524b, self.twiddles_im[10], x8m21);
        let m0524b = FcmaVector::nmadd_rotate90(m0524b, self.twiddles_im[12], x9m20);
        let m0524b = FcmaVector::nmadd_rotate90(m0524b, self.twiddles_im[7], x10m19);
        let m0524b = FcmaVector::nmadd_rotate90(m0524b, self.twiddles_im[2], x11m18);
        ...
        let m0623b = FcmaVector::nmadd_rotate90(m0623b, self.twiddles_im[4], x4m25);
        let m0623b = FcmaVector::fmadd_rotate90(m0623b, self.twiddles_im[0], x5m24);
        let m0623b = FcmaVector::fmadd_rotate90(m0623b, self.twiddles_im[6], x6m23);
        let m0623b = FcmaVector::fmadd_rotate90(m0623b, self.twiddles_im[12], x7m22);
        let m0623b = FcmaVector::nmadd_rotate90(m0623b, self.twiddles_im[9], x8m21);
        let m0623b = FcmaVector::nmadd_rotate90(m0623b, self.twiddles_im[3], x9m20);
        let m0623b = FcmaVector::fmadd_rotate90(m0623b, self.twiddles_im[1], x10m19);
        let m0623b = FcmaVector::fmadd_rotate90(m0623b, self.twiddles_im[7], x11m18);
        ...
        let m0722b = FcmaVector::nmadd_rotate90(m0722b, self.twiddles_im[0], x4m25);
        let m0722b = FcmaVector::fmadd_rotate90(m0722b, self.twiddles_im[5], x5m24);
        let m0722b = FcmaVector::fmadd_rotate90(m0722b, self.twiddles_im[12], x6m23);
        let m0722b = FcmaVector::nmadd_rotate90(m0722b, self.twiddles_im[8], x7m22);
        let m0722b = FcmaVector::nmadd_rotate90(m0722b, self.twiddles_im[1], x8m21);
        let m0722b = FcmaVector::fmadd_rotate90(m0722b, self.twiddles_im[4], x9m20);
        let m0722b = FcmaVector::fmadd_rotate90(m0722b, self.twiddles_im[11], x10m19);
        let m0722b = FcmaVector::nmadd_rotate90(m0722b, self.twiddles_im[9], x11m18);
        ...
        let m0821b = FcmaVector::fmadd_rotate90(m0821b, self.twiddles_im[2], x4m25);
        let m0821b = FcmaVector::fmadd_rotate90(m0821b, self.twiddles_im[10], x5m24);
        let m0821b = FcmaVector::nmadd_rotate90(m0821b, self.twiddles_im[9], x6m23);
        let m0821b = FcmaVector::nmadd_rotate90(m0821b, self.twiddles_im[1], x7m22);
        let m0821b = FcmaVector::fmadd_rotate90(m0821b, self.twiddles_im[5], x8m21);
        let m0821b = FcmaVector::fmadd_rotate90(m0821b, self.twiddles_im[13], x9m20);
        let m0821b = FcmaVector::nmadd_rotate90(m0821b, self.twiddles_im[6], x10m19);
        let m0821b = FcmaVector::fmadd_rotate90(m0821b, self.twiddles_im[0], x11m18);
        ...
        let m0920b = FcmaVector::fmadd_rotate90(m0920b, self.twiddles_im[6], x4m25);
        let m0920b = FcmaVector::nmadd_rotate90(m0920b, self.twiddles_im[12], x5m24);
        let m0920b = FcmaVector::nmadd_rotate90(m0920b, self.twiddles_im[3], x6m23);
        let m0920b = FcmaVector::fmadd_rotate90(m0920b, self.twiddles_im[4], x7m22);
        let m0920b = FcmaVector::fmadd_rotate90(m0920b, self.twiddles_im[13], x8m21);
        let m0920b = FcmaVector::nmadd_rotate90(m0920b, self.twiddles_im[5], x9m20);
        let m0920b = FcmaVector::fmadd_rotate90(m0920b, self.twiddles_im[2], x10m19);
        let m0920b = FcmaVector::fmadd_rotate90(m0920b, self.twiddles_im[11], x11m18);
        ...
        let m1019b = FcmaVector::fmadd_rotate90(m1019b, self.twiddles_im[10], x4m25);
        let m1019b = FcmaVector::nmadd_rotate90(m1019b, self.twiddles_im[7], x5m24);
        let m1019b = FcmaVector::fmadd_rotate90(m1019b, self.twiddles_im[1], x6m23);
        let m1019b = FcmaVector::fmadd_rotate90(m1019b, self.twiddles_im[11], x7m22);
        let m1019b = FcmaVector::nmadd_rotate90(m1019b, self.twiddles_im[6], x8m21);
        let m1019b = FcmaVector::fmadd_rotate90(m1019b, self.twiddles_im[2], x9m20);
        let m1019b = FcmaVector::fmadd_rotate90(m1019b, self.twiddles_im[12], x10m19);
        let m1019b = FcmaVector::nmadd_rotate90(m1019b, self.twiddles_im[5], x11m18);
        ...
        let m1118b = FcmaVector::nmadd_rotate90(m1118b, self.twiddles_im[13], x4m25);
        let m1118b = FcmaVector::nmadd_rotate90(m1118b, self.twiddles_im[2], x5m24);
        let m1118b = FcmaVector::fmadd_rotate90(m1118b, self.twiddles_im[7], x6m23);
        let m1118b = FcmaVector::nmadd_rotate90(m1118b, self.twiddles_im[9], x7m22);
        let m1118b = FcmaVector::fmadd_rotate90(m1118b, self.twiddles_im[0], x8m21);
        let m1118b = FcmaVector::fmadd_rotate90(m1118b, self.twiddles_im[11], x9m20);
        let m1118b = FcmaVector::nmadd_rotate90(m1118b, self.twiddles_im[5], x10m19);
        let m1118b = FcmaVector::fmadd_rotate90(m1118b, self.twiddles_im[4], x11m18);
        ...
        let m1217b = FcmaVector::nmadd_rotate90(m1217b, self.twiddles_im[9], x4m25);
        let m1217b = FcmaVector::fmadd_rotate90(m1217b, self.twiddles_im[1], x5m24);
        let m1217b = FcmaVector::fmadd_rotate90(m1217b, self.twiddles_im[13], x6m23);
        let m1217b = FcmaVector::nmadd_rotate90(m1217b, self.twiddles_im[2], x7m22);
        let m1217b = FcmaVector::fmadd_rotate90(m1217b, self.twiddles_im[8], x8m21);
        let m1217b = FcmaVector::nmadd_rotate90(m1217b, self.twiddles_im[7], x9m20);
        let m1217b = FcmaVector::fmadd_rotate90(m1217b, self.twiddles_im[3], x10m19);
        let m1217b = FcmaVector::nmadd_rotate90(m1217b, self.twiddles_im[12], x11m18);
        ...
        let m1316b = FcmaVector::nmadd_rotate90(m1316b, self.twiddles_im[5], x4m25);
        let m1316b = FcmaVector::fmadd_rotate90(m1316b, self.twiddles_im[6], x5m24);
        let m1316b = FcmaVector::nmadd_rotate90(m1316b, self.twiddles_im[8], x6m23);
        let m1316b = FcmaVector::fmadd_rotate90(m1316b, self.twiddles_im[3], x7m22);
        let m1316b = FcmaVector::nmadd_rotate90(m1316b, self.twiddles_im[11], x8m21);
        let m1316b = FcmaVector::fmadd_rotate90(m1316b, self.twiddles_im[0], x9m20);
        let m1316b = FcmaVector::fmadd_rotate90(m1316b, self.twiddles_im[13], x10m19);
        let m1316b = FcmaVector::nmadd_rotate90(m1316b, self.twiddles_im[1], x11m18);
        ...
        let m1415b = FcmaVector::nmadd_rotate90(m1415b, self.twiddles_im[1], x4m25);
        let m1415b = FcmaVector::fmadd_rotate90(m1415b, self.twiddles_im[11], x5m24);
        let m1415b = FcmaVector::nmadd_rotate90(m1415b, self.twiddles_im[2], x6m23);
        let m1415b = FcmaVector::fmadd_rotate90(m1415b, self.twiddles_im[10], x7m22);
        let m1415b = FcmaVector::nmadd_rotate90(m1415b, self.twiddles_im[3], x8m21);
        let m1415b = FcmaVector::fmadd_rotate90(m1415b, self.twiddles_im[9], x9m20);
        let m1415b = FcmaVector::nmadd_rotate90(m1415b, self.twiddles_im[4], x10m19);
        let m1415b = FcmaVector::fmadd_rotate90(m1415b, self.twiddles_im[8], x11m18);
...
impl<T: FftNum> FcmaF32Butterfly31<T> {
    ...
    pub(crate) unsafe fn perform_parallel_fft_direct(&self, values: [float32x4_t; 31]) -> [float32x4_t; 31] {
        ...
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[3], x4m27);
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[4], x5m26);
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[5], x6m25);
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[6], x7m24);
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[7], x8m23);
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[8], x9m22);
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[9], x10m21);
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[10], x11m20);
        let m0130b = FcmaVector::fmadd_rotate90(m0130b, self.twiddles_im[11], x12m19);
        ...
        let m0229b = FcmaVector::fmadd_rotate90(m0229b, self.twiddles_im[7], x4m27);
        let m0229b = FcmaVector::fmadd_rotate90(m0229b, self.twiddles_im[9], x5m26);
        let m0229b = FcmaVector::fmadd_rotate90(m0229b, self.twiddles_im[11], x6m25);
        let m0229b = FcmaVector::fmadd_rotate90(m0229b, self.twiddles_im[13], x7m24);
        let m0229b = FcmaVector::nmadd_rotate90(m0229b, self.twiddles_im[14], x8m23);
        let m0229b = FcmaVector::nmadd_rotate90(m0229b, self.twiddles_im[12], x9m22);
        let m0229b = FcmaVector::nmadd_rotate90(m0229b, self.twiddles_im[10], x10m21);
        let m0229b = FcmaVector::nmadd_rotate90(m0229b, self.twiddles_im[8], x11m20);
        let m0229b = FcmaVector::nmadd_rotate90(m0229b, self.twiddles_im[6], x12m19);
        ...
        let m0328b = FcmaVector::fmadd_rotate90(m0328b, self.twiddles_im[11], x4m27);
        let m0328b = FcmaVector::fmadd_rotate90(m0328b, self.twiddles_im[14], x5m26);
        let m0328b = FcmaVector::nmadd_rotate90(m0328b, self.twiddles_im[12], x6m25);
        let m0328b = FcmaVector::nmadd_rotate90(m0328b, self.twiddles_im[9], x7m24);
        let m0328b = FcmaVector::nmadd_rotate90(m0328b, self.twiddles_im[6], x8m23);
        let m0328b = FcmaVector::nmadd_rotate90(m0328b, self.twiddles_im[3], x9m22);
        let m0328b = FcmaVector::nmadd_rotate90(m0328b, self.twiddles_im[0], x10m21);
        let m0328b = FcmaVector::fmadd_rotate90(m0328b, self.twiddles_im[1], x11m20);
        let m0328b = FcmaVector::fmadd_rotate90(m0328b, self.twiddles_im[4], x12m19);
        ...
        let m0427b = FcmaVector::nmadd_rotate90(m0427b, self.twiddles_im[14], x4m27);
        let m0427b = FcmaVector::nmadd_rotate90(m0427b, self.twiddles_im[10], x5m26);
        let m0427b = FcmaVector::nmadd_rotate90(m0427b, self.twiddles_im[6], x6m25);
        let m0427b = FcmaVector::nmadd_rotate90(m0427b, self.twiddles_im[2], x7m24);
        let m0427b = FcmaVector::fmadd_rotate90(m0427b, self.twiddles_im[0], x8m23);
        let m0427b = FcmaVector::fmadd_rotate90(m0427b, self.twiddles_im[4], x9m22);
        let m0427b = FcmaVector::fmadd_rotate90(m0427b, self.twiddles_im[8], x10m21);
        let m0427b = FcmaVector::fmadd_rotate90(m0427b, self.twiddles_im[12], x11m20);
        let m0427b = FcmaVector::nmadd_rotate90(m0427b, self.twiddles_im[13], x12m19);
        ...
        let m0526b = FcmaVector::nmadd_rotate90(m0526b, self.twiddles_im[10], x4m27);
        let m0526b = FcmaVector::nmadd_rotate90(m0526b, self.twiddles_im[5], x5m26);
        let m0526b = FcmaVector::nmadd_rotate90(m0526b, self.twiddles_im[0], x6m25);
        let m0526b = FcmaVector::fmadd_rotate90(m0526b, self.twiddles_im[3], x7m24);
        let m0526b = FcmaVector::fmadd_rotate90(m0526b, self.twiddles_im[8], x8m23);
        let m0526b = FcmaVector::fmadd_rotate90(m0526b, self.twiddles_im[13], x9m22);
        let m0526b = FcmaVector::nmadd_rotate90(m0526b, self.twiddles_im[11], x10m21);
        let m0526b = FcmaVector::nmadd_rotate90(m0526b, self.twiddles_im[6], x11m20);
        let m0526b = FcmaVector::nmadd_rotate90(m0526b, self.twiddles_im[1], x12m19);
        ...
        let m0625b = FcmaVector::nmadd_rotate90(m0625b, self.twiddles_im[6], x4m27);
        let m0625b = FcmaVector::nmadd_rotate90(m0625b, self.twiddles_im[0], x5m26);
        let m0625b = FcmaVector::fmadd_rotate90(m0625b, self.twiddles_im[4], x6m25);
        let m0625b = FcmaVector::fmadd_rotate90(m0625b, self.twiddles_im[10], x7m24);
        let m0625b = FcmaVector::nmadd_rotate90(m0625b, self.twiddles_im[13], x8m23);
        let m0625b = FcmaVector::nmadd_rotate90(m0625b, self.twiddles_im[7], x9m22);
        let m0625b = FcmaVector::nmadd_rotate90(m0625b, self.twiddles_im[1], x10m21);
        let m0625b = FcmaVector::fmadd_rotate90(m0625b, self.twiddles_im[3], x11m20);
        let m0625b = FcmaVector::fmadd_rotate90(m0625b, self.twiddles_im[9], x12m19);
        ...
        let m0724b = FcmaVector::nmadd_rotate90(m0724b, self.twiddles_im[2], x4m27);
        let m0724b = FcmaVector::fmadd_rotate90(m0724b, self.twiddles_im[3], x5m26);
        let m0724b = FcmaVector::fmadd_rotate90(m0724b, self.twiddles_im[10], x6m25);
        let m0724b = FcmaVector::nmadd_rotate90(m0724b, self.twiddles_im[12], x7m24);
        let m0724b = FcmaVector::nmadd_rotate90(m0724b, self.twiddles_im[5], x8m23);
        let m0724b = FcmaVector::fmadd_rotate90(m0724b, self.twiddles_im[0], x9m22);
        let m0724b = FcmaVector::fmadd_rotate90(m0724b, self.twiddles_im[7], x10m21);
        let m0724b = FcmaVector::fmadd_rotate90(m0724b, self.twiddles_im[14], x11m20);
        let m0724b = FcmaVector::nmadd_rotate90(m0724b, self.twiddles_im[8], x12m19);
        ...
        let m0823b = FcmaVector::fmadd_rotate90(m0823b, self.twiddles_im[0], x4m27);
        let m0823b = FcmaVector::fmadd_rotate90(m0823b, self.twiddles_im[8], x5m26);
        let m0823b = FcmaVector::nmadd_rotate90(m0823b, self.twiddles_im[13], x6m25);
        let m0823b = FcmaVector::nmadd_rotate90(m0823b, self.twiddles_im[5], x7m24);
        let m0823b = FcmaVector::fmadd_rotate90(m0823b, self.twiddles_im[1], x8m23);
        let m0823b = FcmaVector::fmadd_rotate90(m0823b, self.twiddles_im[9], x9m22);
        let m0823b = FcmaVector::nmadd_rotate90(m0823b, self.twiddles_im[12], x10m21);
        let m0823b = FcmaVector::nmadd_rotate90(m0823b, self.twiddles_im[4], x11m20);
        let m0823b = FcmaVector::fmadd_rotate90(m0823b, self.twiddles_im[2], x12m19);
        ...
        let m0922b = FcmaVector::fmadd_rotate90(m0922b, self.twiddles_im[4], x4m27);
        let m0922b = FcmaVector::fmadd_rotate90(m0922b, self.twiddles_im[13], x5m26);
        let m0922b = FcmaVector::nmadd_rotate90(m0922b, self.twiddles_im[7], x6m25);
        let m0922b = FcmaVector::fmadd_rotate90(m0922b, self.twiddles_im[0], x7m24);
        let m0922b = FcmaVector::fmadd_rotate90(m0922b, self.twiddles_im[9], x8m23);
        let m0922b = FcmaVector::nmadd_rotate90(m0922b, self.twiddles_im[11], x9m22);
        let m0922b = FcmaVector::nmadd_rotate90(m0922b, self.twiddles_im[2], x10m21);
        let m0922b = FcmaVector::fmadd_rotate90(m0922b, self.twiddles_im[5], x11m20);
        let m0922b = FcmaVector::fmadd_rotate90(m0922b, self.twiddles_im[14], x12m19);
        ...
        let m1021b = FcmaVector::fmadd_rotate90(m1021b, self.twiddles_im[8], x4m27);
        let m1021b = FcmaVector::nmadd_rotate90(m1021b, self.twiddles_im[11], x5m26);
        let m1021b = FcmaVector::nmadd_rotate90(m1021b, self.twiddles_im[1], x6m25);
        let m1021b = FcmaVector::fmadd_rotate90(m1021b, self.twiddles_im[7], x7m24);
        let m1021b = FcmaVector::nmadd_rotate90(m1021b, self.twiddles_im[12], x8m23);
        let m1021b = FcmaVector::nmadd_rotate90(m1021b, self.twiddles_im[2], x9m22);
        let m1021b = FcmaVector::fmadd_rotate90(m1021b, self.twiddles_im[6], x10m21);
        let m1021b = FcmaVector::nmadd_rotate90(m1021b, self.twiddles_im[13], x11m20);
        let m1021b = FcmaVector::nmadd_rotate90(m1021b, self.twiddles_im[3], x12m19);
        ...
        let m1120b = FcmaVector::fmadd_rotate90(m1120b, self.twiddles_im[12], x4m27);
        let m1120b = FcmaVector::nmadd_rotate90(m1120b, self.twiddles_im[6], x5m26);
        let m1120b = FcmaVector::fmadd_rotate90(m1120b, self.twiddles_im[3], x6m25);
        let m1120b = FcmaVector::fmadd_rotate90(m1120b, self.twiddles_im[14], x7m24);
        let m1120b = FcmaVector::nmadd_rotate90(m1120b, self.twiddles_im[4], x8m23);
        let m1120b = FcmaVector::fmadd_rotate90(m1120b, self.twiddles_im[5], x9m22);
        let m1120b = FcmaVector::nmadd_rotate90(m1120b, self.twiddles_im[13], x10m21);
        let m1120b = FcmaVector::nmadd_rotate90(m1120b, self.twiddles_im[2], x11m20);
        let m1120b = FcmaVector::fmadd_rotate90(m1120b, self.twiddles_im[7], x12m19);
        ...
        let m1219b = FcmaVector::nmadd_rotate90(m1219b, self.twiddles_im[13], x4m27);
        let m1219b = FcmaVector::nmadd_rotate90(m1219b, self.twiddles_im[1], x5m26);
        let m1219b = FcmaVector::fmadd_rotate90(m1219b, self.twiddles_im[9], x6m25);
        let m1219b = FcmaVector::nmadd_rotate90(m1219b, self.twiddles_im[8], x7m24);
        let m1219b = FcmaVector::fmadd_rotate90(m1219b, self.twiddles_im[2], x8m23);
        let m1219b = FcmaVector::fmadd_rotate90(m1219b, self.twiddles_im[14], x9m22);
        let m1219b = FcmaVector::nmadd_rotate90(m1219b, self.twiddles_im[3], x10m21);
        let m1219b = FcmaVector::fmadd_rotate90(m1219b, self.twiddles_im[7], x11m20);
        let m1219b = FcmaVector::nmadd_rotate90(m1219b, self.twiddles_im[10], x12m19);
        ...
        let m1318b = FcmaVector::nmadd_rotate90(m1318b, self.twiddles_im[9], x4m27);
        let m1318b = FcmaVector::fmadd_rotate90(m1318b, self.twiddles_im[2], x5m26);
        let m1318b = FcmaVector::nmadd_rotate90(m1318b, self.twiddles_im[14], x6m25);
        let m1318b = FcmaVector::nmadd_rotate90(m1318b, self.twiddles_im[1], x7m24);
        let m1318b = FcmaVector::fmadd_rotate90(m1318b, self.twiddles_im[10], x8m23);
        let m1318b = FcmaVector::nmadd_rotate90(m1318b, self.twiddles_im[6], x9m22);
        let m1318b = FcmaVector::fmadd_rotate90(m1318b, self.twiddles_im[5], x10m21);
        let m1318b = FcmaVector::nmadd_rotate90(m1318b, self.twiddles_im[11], x11m20);
        let m1318b = FcmaVector::fmadd_rotate90(m1318b, self.twiddles_im[0], x12m19);
        ...
        let m1417b = FcmaVector::nmadd_rotate90(m1417b, self.twiddles_im[5], x4m27);
        let m1417b = FcmaVector::fmadd_rotate90(m1417b, self.twiddles_im[7], x5m26);
        let m1417b = FcmaVector::nmadd_rotate90(m1417b, self.twiddles_im[8], x6m25);
        let m1417b = FcmaVector::fmadd_rotate90(m1417b, self.twiddles_im[4], x7m24);
        let m1417b = FcmaVector::nmadd_rotate90(m1417b, self.twiddles_im[11], x8m23);
        let m1417b = FcmaVector::fmadd_rotate90(m1417b, self.twiddles_im[1], x9m22);
        let m1417b = FcmaVector::nmadd_rotate90(m1417b, self.twiddles_im[14], x10m21);
        let m1417b = FcmaVector::nmadd_rotate90(m1417b, self.twiddles_im[0], x11m20);
        let m1417b = FcmaVector::fmadd_rotate90(m1417b, self.twiddles_im[12], x12m19);
        ...
        let m1516b = FcmaVector::nmadd_rotate90(m1516b, self.twiddles_im[1], x4m27);
        let m1516b = FcmaVector::fmadd_rotate90(m1516b, self.twiddles_im[12], x5m26);
        let m1516b = FcmaVector::nmadd_rotate90(m1516b, self.twiddles_im[2], x6m25);
        let m1516b = FcmaVector::fmadd_rotate90(m1516b, self.twiddles_im[11], x7m24);
        let m1516b = FcmaVector::nmadd_rotate90(m1516b, self.twiddles_im[3], x8m23);
        let m1516b = FcmaVector::fmadd_rotate90(m1516b, self.twiddles_im[10], x9m22);
        let m1516b = FcmaVector::nmadd_rotate90(m1516b, self.twiddles_im[4], x10m21);
        let m1516b = FcmaVector::fmadd_rotate90(m1516b, self.twiddles_im[9], x11m20);
        let m1516b = FcmaVector::nmadd_rotate90(m1516b, self.twiddles_im[5], x12m19);
