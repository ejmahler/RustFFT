...
use super::sse_butterflies::dual_fft2_interleaved_f32;
...
test_boilerplate_fft_sse_f32_butterfly!(SseF32Butterfly7, 7, |this: &SseF32Butterfly7<_>| this
    .direction);
...
test_boilerplate_fft_sse_f32_butterfly!(SseF32Butterfly11, 11, |this: &SseF32Butterfly11<_>| this
    .direction);
...
impl<T: FftNum> SseF32Butterfly11<T> {
    ...
    pub(crate) unsafe fn perform_dual_fft_direct(&self, values: [__m128; 11]) -> [__m128; 11] {
        ...
        let temp_a3 = calc_f32!(value0 + temp_a3_1 + temp_a3_2 + temp_a3_3 + temp_a3_4 + temp_a3_5);
        ...
        let [x2, x9] = dual_fft2_interleaved_f32(temp_a2, temp_b2_rot);
        let [x3, x8] = dual_fft2_interleaved_f32(temp_a3, temp_b3_rot);
...
test_boilerplate_fft_sse_f32_butterfly!(SseF32Butterfly13, 13, |this: &SseF32Butterfly13<_>| this
    .direction);
...
test_boilerplate_fft_sse_f32_butterfly!(SseF32Butterfly17, 17, |this: &SseF32Butterfly17<_>| this
    .direction);
...
test_boilerplate_fft_sse_f32_butterfly!(SseF32Butterfly19, 19, |this: &SseF32Butterfly19<_>| this
    .direction);
