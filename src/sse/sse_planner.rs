...
mod unit_tests {
    ...
    #[test]
    fn test_multidimensional_planned_sse_2d() {
        let mut planner = FftPlannerSse::<f32>::new().unwrap();
    ...
    #[test]
    fn test_multidimensional_planned_sse_3d() {
        let mut planner = FftPlannerSse::<f32>::new().unwrap();
    ...
    #[test]
    fn test_multidimensional_planned_sse_4d() {
        let mut planner = FftPlannerSse::<f32>::new().unwrap();
    ...
    #[test]
    fn test_multidimensional_planned_sse_5d() {
        let mut planner = FftPlannerSse::<f32>::new().unwrap();
