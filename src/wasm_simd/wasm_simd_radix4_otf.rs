...
use crate::simd::simd_radix4_otf::SimdRadix4OnTheFly;
...
#[allow(dead_code)]
pub type WasmSimdRadix4OnTheFly<S, T> = SimdRadix4OnTheFly<<S as WasmNum>::VectorType, T>;

#[cfg(test)]
mod unit_tests {
    use crate::simd::simd_radix4_otf::test_bodies;
