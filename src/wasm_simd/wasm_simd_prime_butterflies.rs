...
// The code here is mostly autogenerated by the python script tools/gen_sse_butterflies.py, and then translated from SSE to WasmSimd.
//
...
impl<T: FftNum> WasmSimdF32Butterfly7<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle1re = unsafe { f32x4_splat(tw1.re) };
        let twiddle1im = unsafe { f32x4_splat(tw1.im) };
        let twiddle2re = unsafe { f32x4_splat(tw2.re) };
        let twiddle2im = unsafe { f32x4_splat(tw2.im) };
        let twiddle3re = unsafe { f32x4_splat(tw3.re) };
        let twiddle3im = unsafe { f32x4_splat(tw3.im) };
...
impl<T: FftNum> WasmSimdF64Butterfly7<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle3re = unsafe { f64x2_splat(tw3.re) };
        let twiddle3im = unsafe { f64x2_splat(tw3.im) };
...
impl<T: FftNum> WasmSimdF32Butterfly11<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle3re = unsafe { f32x4_splat(tw3.re) };
        let twiddle3im = unsafe { f32x4_splat(tw3.im) };
        let twiddle4re = unsafe { f32x4_splat(tw4.re) };
        let twiddle4im = unsafe { f32x4_splat(tw4.im) };
        let twiddle5re = unsafe { f32x4_splat(tw5.re) };
        let twiddle5im = unsafe { f32x4_splat(tw5.im) };
...
impl<T: FftNum> WasmSimdF64Butterfly11<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle3re = unsafe { f64x2_splat(tw3.re) };
        let twiddle3im = unsafe { f64x2_splat(tw3.im) };
        let twiddle4re = unsafe { f64x2_splat(tw4.re) };
        let twiddle4im = unsafe { f64x2_splat(tw4.im) };
        let twiddle5re = unsafe { f64x2_splat(tw5.re) };
        let twiddle5im = unsafe { f64x2_splat(tw5.im) };
...
impl<T: FftNum> WasmSimdF32Butterfly13<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle5re = unsafe { f32x4_splat(tw5.re) };
        let twiddle5im = unsafe { f32x4_splat(tw5.im) };
        let twiddle6re = unsafe { f32x4_splat(tw6.re) };
        let twiddle6im = unsafe { f32x4_splat(tw6.im) };
...
impl<T: FftNum> WasmSimdF64Butterfly13<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle5re = unsafe { f64x2_splat(tw5.re) };
        let twiddle5im = unsafe { f64x2_splat(tw5.im) };
        let twiddle6re = unsafe { f64x2_splat(tw6.re) };
        let twiddle6im = unsafe { f64x2_splat(tw6.im) };
...
impl<T: FftNum> WasmSimdF32Butterfly17<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle6re = unsafe { f32x4_splat(tw6.re) };
        let twiddle6im = unsafe { f32x4_splat(tw6.im) };
        let twiddle7re = unsafe { f32x4_splat(tw7.re) };
        let twiddle7im = unsafe { f32x4_splat(tw7.im) };
        let twiddle8re = unsafe { f32x4_splat(tw8.re) };
        let twiddle8im = unsafe { f32x4_splat(tw8.im) };
...
impl<T: FftNum> WasmSimdF64Butterfly17<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle6re = unsafe { f64x2_splat(tw6.re) };
        let twiddle6im = unsafe { f64x2_splat(tw6.im) };
        let twiddle7re = unsafe { f64x2_splat(tw7.re) };
        let twiddle7im = unsafe { f64x2_splat(tw7.im) };
        let twiddle8re = unsafe { f64x2_splat(tw8.re) };
        let twiddle8im = unsafe { f64x2_splat(tw8.im) };
...
impl<T: FftNum> WasmSimdF32Butterfly19<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle8re = unsafe { f32x4_splat(tw8.re) };
        let twiddle8im = unsafe { f32x4_splat(tw8.im) };
        let twiddle9re = unsafe { f32x4_splat(tw9.re) };
        let twiddle9im = unsafe { f32x4_splat(tw9.im) };
...
impl<T: FftNum> WasmSimdF64Butterfly19<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle8re = unsafe { f64x2_splat(tw8.re) };
        let twiddle8im = unsafe { f64x2_splat(tw8.im) };
        let twiddle9re = unsafe { f64x2_splat(tw9.re) };
        let twiddle9im = unsafe { f64x2_splat(tw9.im) };
...
impl<T: FftNum> WasmSimdF32Butterfly23<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle9re = unsafe { f32x4_splat(tw9.re) };
        let twiddle9im = unsafe { f32x4_splat(tw9.im) };
        let twiddle10re = unsafe { f32x4_splat(tw10.re) };
        let twiddle10im = unsafe { f32x4_splat(tw10.im) };
        let twiddle11re = unsafe { f32x4_splat(tw11.re) };
        let twiddle11im = unsafe { f32x4_splat(tw11.im) };
...
impl<T: FftNum> WasmSimdF64Butterfly23<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle9re = unsafe { f64x2_splat(tw9.re) };
        let twiddle9im = unsafe { f64x2_splat(tw9.im) };
        let twiddle10re = unsafe { f64x2_splat(tw10.re) };
        let twiddle10im = unsafe { f64x2_splat(tw10.im) };
        let twiddle11re = unsafe { f64x2_splat(tw11.re) };
        let twiddle11im = unsafe { f64x2_splat(tw11.im) };
...
impl<T: FftNum> WasmSimdF32Butterfly29<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle11re = unsafe { f32x4_splat(tw11.re) };
        let twiddle11im = unsafe { f32x4_splat(tw11.im) };
        let twiddle12re = unsafe { f32x4_splat(tw12.re) };
        let twiddle12im = unsafe { f32x4_splat(tw12.im) };
        let twiddle13re = unsafe { f32x4_splat(tw13.re) };
        let twiddle13im = unsafe { f32x4_splat(tw13.im) };
        let twiddle14re = unsafe { f32x4_splat(tw14.re) };
        let twiddle14im = unsafe { f32x4_splat(tw14.im) };
...
impl<T: FftNum> WasmSimdF64Butterfly29<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle11re = unsafe { f64x2_splat(tw11.re) };
        let twiddle11im = unsafe { f64x2_splat(tw11.im) };
        let twiddle12re = unsafe { f64x2_splat(tw12.re) };
        let twiddle12im = unsafe { f64x2_splat(tw12.im) };
        let twiddle13re = unsafe { f64x2_splat(tw13.re) };
        let twiddle13im = unsafe { f64x2_splat(tw13.im) };
        let twiddle14re = unsafe { f64x2_splat(tw14.re) };
        let twiddle14im = unsafe { f64x2_splat(tw14.im) };
...
impl<T: FftNum> WasmSimdF32Butterfly31<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle14re = unsafe { f32x4_splat(tw14.re) };
        let twiddle14im = unsafe { f32x4_splat(tw14.im) };
        let twiddle15re = unsafe { f32x4_splat(tw15.re) };
        let twiddle15im = unsafe { f32x4_splat(tw15.im) };
...
impl<T: FftNum> WasmSimdF64Butterfly31<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        ...
        let twiddle14re = unsafe { f64x2_splat(tw14.re) };
        let twiddle14im = unsafe { f64x2_splat(tw14.im) };
        let twiddle15re = unsafe { f64x2_splat(tw15.re) };
        let twiddle15im = unsafe { f64x2_splat(tw15.im) };
