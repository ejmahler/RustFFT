...
boilerplate_fft_commondata_fully_generic!(MixedRadix2xnAvx);
...
boilerplate_fft_commondata_fully_generic!(MixedRadix3xnAvx);

impl<T: FFTnum> MixedRadix3xnAvx<T> {
    #[target_feature(enable = "avx")]
    unsafe fn new_with_avx(inner_fft: Arc<dyn Fft<T>>) -> Self {
        Self {
            twiddles_butterfly3: T::AvxType::broadcast_twiddle(1, 3, inner_fft.is_inverse()),
...
boilerplate_fft_commondata_fully_generic!(MixedRadix4xnAvx);

impl<T: FFTnum> MixedRadix4xnAvx<T> {
    #[target_feature(enable = "avx")]
    unsafe fn new_with_avx(inner_fft: Arc<dyn Fft<T>>) -> Self {
        Self {
            twiddles_butterfly4: T::AvxType::make_rotation90(inner_fft.is_inverse()),
...
mod unit_tests {
    ...
    macro_rules! test_avx_mixed_radix_generic {
        ($f32_test_name:ident, $f64_test_name:ident, $struct_name:ident, $inner_count:expr) => (
            #[test]
            fn $f32_test_name() {
                for inner_fft_len in 1..32 {
    ...
    test_avx_mixed_radix_generic!(test_mixedradix_2xn_avx_f32, test_mixedradix_2xn_avx_f64, MixedRadix2xnAvx, 2);
    test_avx_mixed_radix_generic!(test_mixedradix_3xn_avx_f32, test_mixedradix_3xn_avx_f64, MixedRadix3xnAvx, 3);
    test_avx_mixed_radix_generic!(test_mixedradix_4xn_avx_f32, test_mixedradix_4xn_avx_f64, MixedRadix4xnAvx, 4);
