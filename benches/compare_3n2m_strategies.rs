...
#[bench] fn comparef32_len0000001_2power00_3power00(b: &mut Bencher) { bench_planned_fft_f32(b, 1); }
#[bench] fn comparef32_len0000003_2power00_3power01(b: &mut Bencher) { bench_planned_fft_f32(b, 3); }
#[bench] fn comparef32_len0000009_2power00_3power02(b: &mut Bencher) { bench_planned_fft_f32(b, 9); }
#[bench] fn comparef32_len0000027_2power00_3power03(b: &mut Bencher) { bench_planned_fft_f32(b, 27); }
#[bench] fn comparef32_len0000081_2power00_3power04(b: &mut Bencher) { bench_planned_fft_f32(b, 81); }
#[bench] fn comparef32_len0000243_2power00_3power05(b: &mut Bencher) { bench_planned_fft_f32(b, 243); }
#[bench] fn comparef32_len0000729_2power00_3power06(b: &mut Bencher) { bench_planned_fft_f32(b, 729); }
#[bench] fn comparef32_len0002187_2power00_3power07(b: &mut Bencher) { bench_planned_fft_f32(b, 2187); }
#[bench] fn comparef32_len0006561_2power00_3power08(b: &mut Bencher) { bench_planned_fft_f32(b, 6561); }
#[bench] fn comparef32_len0019683_2power00_3power09(b: &mut Bencher) { bench_planned_fft_f32(b, 19683); }
#[bench] fn comparef32_len0059049_2power00_3power10(b: &mut Bencher) { bench_planned_fft_f32(b, 59049); }
#[bench] fn comparef32_len0177147_2power00_3power11(b: &mut Bencher) { bench_planned_fft_f32(b, 177147); }
#[bench] fn comparef32_len0531441_2power00_3power12(b: &mut Bencher) { bench_planned_fft_f32(b, 531441); }
#[bench] fn comparef32_len1594323_2power00_3power13(b: &mut Bencher) { bench_planned_fft_f32(b, 1594323); }
#[bench] fn comparef32_len4782969_2power00_3power14(b: &mut Bencher) { bench_planned_fft_f32(b, 4782969); }
#[bench] fn comparef32_len0000002_2power01_3power00(b: &mut Bencher) { bench_planned_fft_f32(b, 2); }
#[bench] fn comparef32_len0000006_2power01_3power01(b: &mut Bencher) { bench_planned_fft_f32(b, 6); }
#[bench] fn comparef32_len0000018_2power01_3power02(b: &mut Bencher) { bench_planned_fft_f32(b, 18); }
#[bench] fn comparef32_len0000054_2power01_3power03(b: &mut Bencher) { bench_planned_fft_f32(b, 54); }
#[bench] fn comparef32_len0000162_2power01_3power04(b: &mut Bencher) { bench_planned_fft_f32(b, 162); }
#[bench] fn comparef32_len0000486_2power01_3power05(b: &mut Bencher) { bench_planned_fft_f32(b, 486); }
#[bench] fn comparef32_len0001458_2power01_3power06(b: &mut Bencher) { bench_planned_fft_f32(b, 1458); }
#[bench] fn comparef32_len0004374_2power01_3power07(b: &mut Bencher) { bench_planned_fft_f32(b, 4374); }
#[bench] fn comparef32_len0013122_2power01_3power08(b: &mut Bencher) { bench_planned_fft_f32(b, 13122); }
#[bench] fn comparef32_len0039366_2power01_3power09(b: &mut Bencher) { bench_planned_fft_f32(b, 39366); }
#[bench] fn comparef32_len0118098_2power01_3power10(b: &mut Bencher) { bench_planned_fft_f32(b, 118098); }
#[bench] fn comparef32_len0354294_2power01_3power11(b: &mut Bencher) { bench_planned_fft_f32(b, 354294); }
#[bench] fn comparef32_len1062882_2power01_3power12(b: &mut Bencher) { bench_planned_fft_f32(b, 1062882); }
#[bench] fn comparef32_len3188646_2power01_3power13(b: &mut Bencher) { bench_planned_fft_f32(b, 3188646); }
...
#[bench] fn comparef32_len0131072_2power17_3power00(b: &mut Bencher) { bench_planned_fft_f32(b, 131072); }
#[bench] fn comparef32_len0393216_2power17_3power01(b: &mut Bencher) { bench_planned_fft_f32(b, 393216); }
...
#[bench] fn comparef32_len0262144_2power18_3power00(b: &mut Bencher) { bench_planned_fft_f32(b, 262144); }
#[bench] fn comparef32_len0786432_2power18_3power01(b: &mut Bencher) { bench_planned_fft_f32(b, 786432); }
#[bench] fn comparef32_len2359296_2power18_3power02(b: &mut Bencher) { bench_planned_fft_f32(b, 2359296); }
#[bench] fn comparef32_len7077888_2power18_3power03(b: &mut Bencher) { bench_planned_fft_f32(b, 7077888); }
#[bench] fn comparef32_len0524288_2power19_3power00(b: &mut Bencher) { bench_planned_fft_f32(b, 524288); }
#[bench] fn comparef32_len1572864_2power19_3power01(b: &mut Bencher) { bench_planned_fft_f32(b, 1572864); }
#[bench] fn comparef32_len4718592_2power19_3power02(b: &mut Bencher) { bench_planned_fft_f32(b, 4718592); }
#[bench] fn comparef32_len1048576_2power20_3power00(b: &mut Bencher) { bench_planned_fft_f32(b, 1048576); }
#[bench] fn comparef32_len3145728_2power20_3power01(b: &mut Bencher) { bench_planned_fft_f32(b, 3145728); }
#[bench] fn comparef32_len2097152_2power21_3power00(b: &mut Bencher) { bench_planned_fft_f32(b, 2097152); }
#[bench] fn comparef32_len6291456_2power21_3power01(b: &mut Bencher) { bench_planned_fft_f32(b, 6291456); }
#[bench] fn comparef32_len4194304_2power22_3power00(b: &mut Bencher) { bench_planned_fft_f32(b, 4194304); }