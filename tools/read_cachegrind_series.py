...
if __name__ == "__main__":
    ...
    butterfly_length = [2, 3, 4, 5, 6, 7, 8, 11, 13, 16, 17, 19, 23, 29, 31, 32]
    butterfly_cycles = []
    for fftlen in butterfly_length:
        fname = f"target/iai/cachegrind.out.bench_butterfly_{fftlen}"
        fname_noop = f"target/iai/cachegrind.out.bench_butterfly_setup_{fftlen}"
